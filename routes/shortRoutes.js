...
const { generateNewUrl, getAnalytics ,redirectShortUrl} = require("../controllers/url");
...
router.route("/shorten").post(limiter, generateNewUrl); // Ensure generateNewUrl is passed correctly
